    ...
    public partial class Finalmig : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", 0, "af55ad18-0bf2-437e-9515-b6fb1fb218c5", "adminUser@example.com", true, null, false, null, "adminUser@EXAMPLE.COM", "ADMIN", "AQAAAAIAAYagAAAAEDMyH+Qi6BSByKoNZHKrFmg1xGfGAfS6fqNmFbX9v2P77vFDeGkU40HVgQoWHuVWGQ==", "1234567890", false, "9353e446-20a8-4f3b-b8dc-081b2fbee19a", false, "admin" },
                    { "2", 0, "7e7af55c-9a6a-405e-8ef6-24c1da0210c0", "hotel@example.com", true, null, false, null, "hotel@EXAMPLE.COM", "HOTEL", "AQAAAAIAAYagAAAAEPKYbTI1lM441IQkz9YDz6jZhlUqVjD5hfoJpnorE6oT2Fj6xR273gFcH6BhA8B0nw==", "1234567890", false, "3bc50738-6e9f-4c69-8440-6157d4b939de", false, "hotel" },
                    { "3", 0, "cf6dd018-22ac-4045-aab2-efe81eae7a6e", "trip@example.com", true, null, false, null, "trip@EXAMPLE.COM", "TRIP", "AQAAAAIAAYagAAAAEPz74dRVlQM/fVxaL/AVfJLfgYIEk0QNN4VH+A1a9lJTIxEIIdZeYoG0EGHb/IqYMw==", "1234567890", false, "c23f6cd3-1b78-453d-854f-44a39e0653d5", false, "trip" },
                    { "4", 0, "b1ca4409-c9f1-4bb3-ba44-166735d09631", "User@example.com", true, null, false, null, null, "USER", "AQAAAAIAAYagAAAAEE95gvVoaj87cngC2DkZ2/GM7njEq8fBFEo7GtlVmKE54mwwdsGInFoGewOT7DtShg==", "1234567890", false, "b6b86fbf-6f08-4133-b9aa-816ff3ab5e37", false, "User" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "walking", 30, 20m, 0, "trip start at 8 am and going from Amman to Petra", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8288), "Petra ride", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8274), 1 },
                    { 2, "visiting", 22, 30m, 0, "Amman to Jerash with a trip manager who can speak many languages", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8291), "Jerash ride", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8291), 1 },
                    { 3, "climbing", 40, 40m, 0, "Amman to Irbid with a trip manager who can speak many languages", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8293), "Um-Qais ride", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8293), 1 },
                    { 4, "desert safari", 20, 50m, 0, "Explore the breathtaking Wadi Rum desert in Jordan.", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8295), "Wadi Rum Adventure", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8295), 2 },
                    { 5, "swimming and mud baths", 15, 25m, 0, "Relax at the world-famous Dead Sea and experience its healing properties.", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8297), "Dead Sea Relaxation", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8297), 2 },
                    { 6, "scuba diving", 10, 60m, 0, "Discover the vibrant marine life of the Red Sea in Aqaba.", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8299), "Aqaba Diving Expedition", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8299), 2 },
                    { 7, "sightseeing", 25, 15m, 0, "Explore the historical and cultural landmarks of Amman.", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8301), "Amman City Tour", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8301), 3 },
                    { 8, "hiking", 12, 35m, 0, "Trek through the stunning Dana Biosphere Reserve.", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8303), "Dana Biosphere Reserve Hike", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8303), 3 },
                    { 9, "canyoning", 18, 45m, 0, "Experience the adventure of canyoning in Wadi Mujib.", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8305), "Wadi Mujib Canyoning", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8305), 3 },
                    { 10, "relaxation", 30, 20m, 0, "Relax in the soothing hot springs of Ma'in.", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8307), "Ma'in Hot Springs Visit", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8307), 4 },
                    { 11, "historical tour", 20, 25m, 0, "Explore the historic Kerak Castle in Jordan.", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8311), "Kerak Castle Tour", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8311), 4 },
                    { 12, "nature walk", 15, 30m, 0, "Take a nature walk in the Ajloun Forest Reserve.", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8314), "Ajloun Forest Reserve Trek", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8313), 4 },
                    { 13, "food tasting", 12, 40m, 0, "Indulge in a culinary journey through Amman's cuisine.", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8315), "Amman Culinary Tour", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8315), 4 },
                    { 14, "mosaic art", 25, 20m, 0, "Discover the mosaic art of Madaba.", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8317), "Mosaic City Madaba", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8317), 4 },
                    { 15, "historical tour", 18, 30m, 0, "Explore the historic Ajloun Castle.", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8319), "Ajloun Castle Exploration", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8319), 4 },
                    { 16, "beach relaxation", 20, 55m, 0, "Relax on the beautiful beaches of Aqaba.", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8321), "Aqaba Beach Getaway", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8321), 5 },
                    { 17, "snorkeling", 15, 40m, 0, "Explore the underwater world of the Red Sea through snorkeling in Aqaba.", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8323), "Aqaba Snorkeling Adventure", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8322), 5 },
                    { 18, "boat tour", 25, 30m, 0, "View marine life through a glass-bottom boat tour in Aqaba.", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8325), "Aqaba Glass-Bottom Boat Tour", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8324), 5 },
                    { 19, "desert adventure", 12, 45m, 0, "Embark on an exciting jeep safari in the Aqaba desert.", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8326), "Aqaba Desert Jeep Safari", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8326), 6 },
                    { 20, "nightclub hopping", 20, 25m, 0, "Experience the vibrant nightlife of Aqaba.", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8328), "Aqaba Nightlife Tour", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8328), 6 },
                    { 21, "historical tour", 15, 60m, 0, "Explore the iconic Pyramids of Giza in Egypt.", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8331), "Pyramids of Giza Tour", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8331), 6 },
                    { 22, "theater", 18, 60m, 0, "Attend a Broadway show in the heart of New York City.", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8333), "Broadway Show Experience", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8333), 7 },
                    { 23, "museum visit", 20, 30m, 0, "Explore the museums along Museum Mile.", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8335), "Museum Mile Tour", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8334), 7 },
                    { 24, "walking tour", 35, 20m, 0, "Take a scenic walk across the historic Brooklyn Bridge.", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8337), "Brooklyn Bridge Walk", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8336), 7 },
                    { 25, "sightseeing", 30, 35m, 0, "Enjoy panoramic views from the Empire State Building.", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8339), "Empire State Building Observation Deck", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8338), 8 },
                    { 26, "boat tour", 25, 45m, 0, "Cruise along the Hudson River and see Manhattan's skyline.", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8343), "Hudson River Boat Tour", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8342), 8 },
                    { 27, "cultural tour", 20, 45m, 0, "Immerse in the rich culture of Ubud, Bali.", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8344), "Ubud Cultural Experience", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8344), 8 },
                    { 28, "snorkeling", 30, 60m, 0, "Explore the vibrant marine life of the Red Sea in Aqaba", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8346), "Red Sea Adventure", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8346), 9 },
                    { 29, "off-roading", 20, 50m, 0, "Experience the thrill of a desert adventure in Aqaba", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8348), "Desert Safari", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8348), 9 },
                    { 30, "scuba diving", 15, 70m, 0, "Discover submerged historical sites in the Red Sea", new DateTime(2023, 10, 25, 19, 34, 31, 477, DateTimeKind.Utc).AddTicks(8350), "Historical Dive", new DateTime(2023, 10, 25, 22, 34, 31, 477, DateTimeKind.Local).AddTicks(8349), 9 }
                });
