    ...
    public partial class newMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", 0, "1d56681c-e133-4595-9f16-f56f200b3505", "adminUser@example.com", true, false, null, "adminUser@EXAMPLE.COM", "ADMIN", "AQAAAAIAAYagAAAAEJ9XreKnS2Ew01WRjjVgPO1+f72xIuV+32XF5b0GnWJJk0dQSwZTWcMXhbasLQiKHQ==", "1234567890", false, "989f00ff-b8ae-4fce-91d0-d613177ce89e", false, "admin" },
                    { "2", 0, "481e7a76-4734-461e-a6e6-e6217e8f4d44", "hotel@example.com", true, false, null, "hotel@EXAMPLE.COM", "HOTEL", "AQAAAAIAAYagAAAAEKQUCcxbgfTdYha0VXBIMfLgP5E13Cf93ZHTJd8DuI2AVAkQKjoF5dqQFrRgxQOg0A==", "1234567890", false, "3aa18fa2-2d3a-49c7-9169-fe269d811ec1", false, "hotel" },
                    { "3", 0, "e087cf76-ecb8-469c-a85b-06d7643ee2f6", "trip@example.com", true, false, null, "trip@EXAMPLE.COM", "TRIP", "AQAAAAIAAYagAAAAEPgbTBGkPLCR+hPnMcmHKD++V05XVhL9EchSyC8bkpOB8t/Fth68JqaSejmx5pkNvw==", "1234567890", false, "b8089d15-9f8d-4563-93c7-9afb81543a45", false, "trip" },
                    { "4", 0, "dba0232f-6586-415b-a348-700761f8e17c", "User@example.com", true, false, null, null, "USER", "AQAAAAIAAYagAAAAEPIidXEMwyEanzNmYSDTycEsdi0OfDbg349S3nhfDL+yPAFuZMkwJHd0MsoH4MjiBQ==", "1234567890", false, "9422a87f-cd83-4533-b0ab-a5eda7af25d3", false, "User" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "walking", 30, 20m, 0, "trip start at 8 am and going from Amman to Petra", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1204), "Petra ride", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1192), 1 },
                    { 2, "visiting", 22, 30m, 0, "Amman to Jerash with a trip manager who can speak many languages", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1208), "Jerash ride", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1207), 1 },
                    { 3, "climbing", 40, 40m, 0, "Amman to Irbid with a trip manager who can speak many languages", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1210), "Um-Qais ride", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1209), 1 },
                    { 4, "desert safari", 20, 50m, 0, "Explore the breathtaking Wadi Rum desert in Jordan.", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1213), "Wadi Rum Adventure", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1212), 2 },
                    { 5, "swimming and mud baths", 15, 25m, 0, "Relax at the world-famous Dead Sea and experience its healing properties.", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1215), "Dead Sea Relaxation", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1214), 2 },
                    { 6, "scuba diving", 10, 60m, 0, "Discover the vibrant marine life of the Red Sea in Aqaba.", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1255), "Aqaba Diving Expedition", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1254), 2 },
                    { 7, "sightseeing", 25, 15m, 0, "Explore the historical and cultural landmarks of Amman.", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1257), "Amman City Tour", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1256), 3 },
                    { 8, "hiking", 12, 35m, 0, "Trek through the stunning Dana Biosphere Reserve.", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1259), "Dana Biosphere Reserve Hike", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1258), 3 },
                    { 9, "canyoning", 18, 45m, 0, "Experience the adventure of canyoning in Wadi Mujib.", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1260), "Wadi Mujib Canyoning", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1260), 3 },
                    { 10, "relaxation", 30, 20m, 0, "Relax in the soothing hot springs of Ma'in.", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1262), "Ma'in Hot Springs Visit", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1262), 4 },
                    { 11, "historical tour", 20, 25m, 0, "Explore the historic Kerak Castle in Jordan.", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1265), "Kerak Castle Tour", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1265), 4 },
                    { 12, "nature walk", 15, 30m, 0, "Take a nature walk in the Ajloun Forest Reserve.", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1267), "Ajloun Forest Reserve Trek", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1267), 4 },
                    { 13, "food tasting", 12, 40m, 0, "Indulge in a culinary journey through Amman's cuisine.", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1269), "Amman Culinary Tour", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1269), 4 },
                    { 14, "mosaic art", 25, 20m, 0, "Discover the mosaic art of Madaba.", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1271), "Mosaic City Madaba", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1271), 4 },
                    { 15, "historical tour", 18, 30m, 0, "Explore the historic Ajloun Castle.", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1273), "Ajloun Castle Exploration", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1273), 4 },
                    { 16, "beach relaxation", 20, 55m, 0, "Relax on the beautiful beaches of Aqaba.", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1275), "Aqaba Beach Getaway", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1274), 5 },
                    { 17, "snorkeling", 15, 40m, 0, "Explore the underwater world of the Red Sea through snorkeling in Aqaba.", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1277), "Aqaba Snorkeling Adventure", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1276), 5 },
                    { 18, "boat tour", 25, 30m, 0, "View marine life through a glass-bottom boat tour in Aqaba.", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1279), "Aqaba Glass-Bottom Boat Tour", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1278), 5 },
                    { 19, "desert adventure", 12, 45m, 0, "Embark on an exciting jeep safari in the Aqaba desert.", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1282), "Aqaba Desert Jeep Safari", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1281), 6 },
                    { 20, "nightclub hopping", 20, 25m, 0, "Experience the vibrant nightlife of Aqaba.", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1284), "Aqaba Nightlife Tour", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1283), 6 },
                    { 21, "historical tour", 15, 60m, 0, "Explore the iconic Pyramids of Giza in Egypt.", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1286), "Pyramids of Giza Tour", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1286), 6 },
                    { 22, "theater", 18, 60m, 0, "Attend a Broadway show in the heart of New York City.", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1288), "Broadway Show Experience", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1288), 7 },
                    { 23, "museum visit", 20, 30m, 0, "Explore the museums along Museum Mile.", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1290), "Museum Mile Tour", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1290), 7 },
                    { 24, "walking tour", 35, 20m, 0, "Take a scenic walk across the historic Brooklyn Bridge.", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1292), "Brooklyn Bridge Walk", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1292), 7 },
                    { 25, "sightseeing", 30, 35m, 0, "Enjoy panoramic views from the Empire State Building.", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1294), "Empire State Building Observation Deck", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1294), 8 },
                    { 26, "boat tour", 25, 45m, 0, "Cruise along the Hudson River and see Manhattan's skyline.", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1296), "Hudson River Boat Tour", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1296), 8 },
                    { 27, "cultural tour", 20, 45m, 0, "Immerse in the rich culture of Ubud, Bali.", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1298), "Ubud Cultural Experience", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1297), 8 },
                    { 28, "snorkeling", 30, 60m, 0, "Explore the vibrant marine life of the Red Sea in Aqaba", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1300), "Red Sea Adventure", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1299), 9 },
                    { 29, "off-roading", 20, 50m, 0, "Experience the thrill of a desert adventure in Aqaba", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1302), "Desert Safari", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1301), 9 },
                    { 30, "scuba diving", 15, 70m, 0, "Discover submerged historical sites in the Red Sea", new DateTime(2023, 10, 23, 20, 50, 28, 26, DateTimeKind.Utc).AddTicks(1303), "Historical Dive", new DateTime(2023, 10, 23, 23, 50, 28, 26, DateTimeKind.Local).AddTicks(1303), 9 }
                });
