    ...
    public partial class osama : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", 0, "5072e441-6c1d-4c33-b303-6cbb0f5dee4c", "adminUser@example.com", true, null, false, null, "adminUser@EXAMPLE.COM", "ADMIN", "AQAAAAIAAYagAAAAELJh+Wh13z4PMrKvsEhlECeRqCSe96YMC8rRoGQ+MRzprmHsynuui+ofWvivlTZnvw==", "1234567890", false, "2e82b839-624f-49f3-8389-b2ddf44f5bb4", false, "admin" },
                    { "2", 0, "4c3a005c-d305-4fa2-9ba6-7145e51957bb", "hotel@example.com", true, null, false, null, "hotel@EXAMPLE.COM", "HOTEL", "AQAAAAIAAYagAAAAEASTfc0CSYhJNpWvsHMm7oLUi+DzGXMHAn5CMvXLWfjRtwNMC6I+WydkpcRJQci3TQ==", "1234567890", false, "7ab8a61a-313c-4c9d-b465-94e5b86f01e5", false, "hotel" },
                    { "3", 0, "32e56d42-4620-4016-8c02-8ab5086b2ab0", "trip@example.com", true, null, false, null, "trip@EXAMPLE.COM", "TRIP", "AQAAAAIAAYagAAAAEAdjkheYiHN5O3NAp+Kac74vU6Jmk6X9GDibinUL9w21w4+iQtgUtZx3KOpe4VOrlw==", "1234567890", false, "51dce29d-f8fc-4584-a4f4-136d6b6892ad", false, "trip" },
                    { "4", 0, "d94bae6e-f474-4dd5-9777-5f347db82591", "User@example.com", true, null, false, null, null, "USER", "AQAAAAIAAYagAAAAEB8YrrORgRU9KjYO0/poEc+v5aw+ALrqXBXXrWN7eCs51C0gITLgdMegTfoCExFerw==", "1234567890", false, "8a6c9700-3a6d-46ca-b559-85aaf85ded6a", false, "User" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "walking", 30, 20m, 0, "trip start at 8 am and going from Amman to Petra", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9605), "Petra ride", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9554), 1 },
                    { 2, "visiting", 22, 30m, 0, "Amman to Jerash with a trip manager who can speak many languages", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9610), "Jerash ride", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9608), 1 },
                    { 3, "climbing", 40, 40m, 0, "Amman to Irbid with a trip manager who can speak many languages", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9614), "Um-Qais ride", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9612), 1 },
                    { 4, "desert safari", 20, 50m, 0, "Explore the breathtaking Wadi Rum desert in Jordan.", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9618), "Wadi Rum Adventure", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9616), 2 },
                    { 5, "swimming and mud baths", 15, 25m, 0, "Relax at the world-famous Dead Sea and experience its healing properties.", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9630), "Dead Sea Relaxation", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9620), 2 },
                    { 6, "scuba diving", 10, 60m, 0, "Discover the vibrant marine life of the Red Sea in Aqaba.", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9641), "Aqaba Diving Expedition", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9634), 2 },
                    { 7, "sightseeing", 25, 15m, 0, "Explore the historical and cultural landmarks of Amman.", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9645), "Amman City Tour", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9642), 3 },
                    { 8, "hiking", 12, 35m, 0, "Trek through the stunning Dana Biosphere Reserve.", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9648), "Dana Biosphere Reserve Hike", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9646), 3 },
                    { 9, "canyoning", 18, 45m, 0, "Experience the adventure of canyoning in Wadi Mujib.", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9652), "Wadi Mujib Canyoning", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9650), 3 },
                    { 10, "relaxation", 30, 20m, 0, "Relax in the soothing hot springs of Ma'in.", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9659), "Ma'in Hot Springs Visit", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9654), 4 },
                    { 11, "historical tour", 20, 25m, 0, "Explore the historic Kerak Castle in Jordan.", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9663), "Kerak Castle Tour", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9661), 4 },
                    { 12, "nature walk", 15, 30m, 0, "Take a nature walk in the Ajloun Forest Reserve.", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9667), "Ajloun Forest Reserve Trek", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9665), 4 },
                    { 13, "food tasting", 12, 40m, 0, "Indulge in a culinary journey through Amman's cuisine.", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9671), "Amman Culinary Tour", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9669), 4 },
                    { 14, "mosaic art", 25, 20m, 0, "Discover the mosaic art of Madaba.", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9677), "Mosaic City Madaba", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9675), 4 },
                    { 15, "historical tour", 18, 30m, 0, "Explore the historic Ajloun Castle.", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9702), "Ajloun Castle Exploration", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9679), 4 },
                    { 16, "beach relaxation", 20, 55m, 0, "Relax on the beautiful beaches of Aqaba.", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9705), "Aqaba Beach Getaway", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9703), 5 },
                    { 17, "snorkeling", 15, 40m, 0, "Explore the underwater world of the Red Sea through snorkeling in Aqaba.", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9709), "Aqaba Snorkeling Adventure", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9707), 5 },
                    { 18, "boat tour", 25, 30m, 0, "View marine life through a glass-bottom boat tour in Aqaba.", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9712), "Aqaba Glass-Bottom Boat Tour", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9711), 5 },
                    { 19, "desert adventure", 12, 45m, 0, "Embark on an exciting jeep safari in the Aqaba desert.", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9716), "Aqaba Desert Jeep Safari", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9714), 6 },
                    { 20, "nightclub hopping", 20, 25m, 0, "Experience the vibrant nightlife of Aqaba.", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9720), "Aqaba Nightlife Tour", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9718), 6 },
                    { 21, "historical tour", 15, 60m, 0, "Explore the iconic Pyramids of Giza in Egypt.", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9724), "Pyramids of Giza Tour", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9722), 6 },
                    { 22, "theater", 18, 60m, 0, "Attend a Broadway show in the heart of New York City.", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9728), "Broadway Show Experience", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9726), 7 },
                    { 23, "museum visit", 20, 30m, 0, "Explore the museums along Museum Mile.", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9732), "Museum Mile Tour", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9730), 7 },
                    { 24, "walking tour", 35, 20m, 0, "Take a scenic walk across the historic Brooklyn Bridge.", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9736), "Brooklyn Bridge Walk", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9734), 7 },
                    { 25, "sightseeing", 30, 35m, 0, "Enjoy panoramic views from the Empire State Building.", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9739), "Empire State Building Observation Deck", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9738), 8 },
                    { 26, "boat tour", 25, 45m, 0, "Cruise along the Hudson River and see Manhattan's skyline.", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9743), "Hudson River Boat Tour", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9741), 8 },
                    { 27, "cultural tour", 20, 45m, 0, "Immerse in the rich culture of Ubud, Bali.", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9747), "Ubud Cultural Experience", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9745), 8 },
                    { 28, "snorkeling", 30, 60m, 0, "Explore the vibrant marine life of the Red Sea in Aqaba", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9750), "Red Sea Adventure", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9748), 9 },
                    { 29, "off-roading", 20, 50m, 0, "Experience the thrill of a desert adventure in Aqaba", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9754), "Desert Safari", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9752), 9 },
                    { 30, "scuba diving", 15, 70m, 0, "Discover submerged historical sites in the Red Sea", new DateTime(2023, 10, 24, 17, 22, 22, 225, DateTimeKind.Utc).AddTicks(9806), "Historical Dive", new DateTime(2023, 10, 24, 20, 22, 22, 225, DateTimeKind.Local).AddTicks(9762), 9 }
                });
