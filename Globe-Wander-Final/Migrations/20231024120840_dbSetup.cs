    ...
    public partial class dbSetup : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", 0, "2ef3c30c-dded-461d-9939-68fbae6799d0", "adminUser@example.com", true, null, false, null, "adminUser@EXAMPLE.COM", "ADMIN", "AQAAAAIAAYagAAAAEF033NJgJWhTq4TC29KDuTMoQQX9M0l0KDC+eGa9GeW1oo/lhJklEjrd+Lmxhb+HEw==", "1234567890", false, "5ccdaddf-a165-441c-8e00-57a885a034f3", false, "admin" },
                    { "2", 0, "2c846246-89fb-4af8-ba9b-5764af031251", "hotel@example.com", true, null, false, null, "hotel@EXAMPLE.COM", "HOTEL", "AQAAAAIAAYagAAAAEKVnFuc/3/u1XSFia5qkhehhw0P6N/o/BH1NzwiAkAfdNcbfMnSktpdbaocnjVecnA==", "1234567890", false, "19688162-5e22-4e6a-a026-0b1b23d46966", false, "hotel" },
                    { "3", 0, "d07774d1-ce62-4c03-aef9-3e81d4845a04", "trip@example.com", true, null, false, null, "trip@EXAMPLE.COM", "TRIP", "AQAAAAIAAYagAAAAEGirQF0Sjy62ztPkEEap7p6Tcm70RwTcZDBGWs54rNPprmOYgnKWv3kX6jgJlZH4lA==", "1234567890", false, "01ecd87b-d6e9-4114-8b41-2d85246b1eec", false, "trip" },
                    { "4", 0, "a4654b51-2da3-4e01-a7b0-d2ad0e10d366", "User@example.com", true, null, false, null, null, "USER", "AQAAAAIAAYagAAAAEJJcYKmbVKedpgmooBqJnYL+lv3AQmBVpmR0sobb+HEoZ3uWfrYFzzlmvQj/Bgvc1g==", "1234567890", false, "d22c3125-3ef4-4549-90d1-94059c8061f6", false, "User" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "walking", 30, 20m, 0, "trip start at 8 am and going from Amman to Petra", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1918), "Petra ride", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1906), 1 },
                    { 2, "visiting", 22, 30m, 0, "Amman to Jerash with a trip manager who can speak many languages", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1923), "Jerash ride", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1922), 1 },
                    { 3, "climbing", 40, 40m, 0, "Amman to Irbid with a trip manager who can speak many languages", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1926), "Um-Qais ride", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1925), 1 },
                    { 4, "desert safari", 20, 50m, 0, "Explore the breathtaking Wadi Rum desert in Jordan.", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1929), "Wadi Rum Adventure", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1928), 2 },
                    { 5, "swimming and mud baths", 15, 25m, 0, "Relax at the world-famous Dead Sea and experience its healing properties.", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1931), "Dead Sea Relaxation", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1930), 2 },
                    { 6, "scuba diving", 10, 60m, 0, "Discover the vibrant marine life of the Red Sea in Aqaba.", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1934), "Aqaba Diving Expedition", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1933), 2 },
                    { 7, "sightseeing", 25, 15m, 0, "Explore the historical and cultural landmarks of Amman.", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1938), "Amman City Tour", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1937), 3 },
                    { 8, "hiking", 12, 35m, 0, "Trek through the stunning Dana Biosphere Reserve.", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1940), "Dana Biosphere Reserve Hike", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1940), 3 },
                    { 9, "canyoning", 18, 45m, 0, "Experience the adventure of canyoning in Wadi Mujib.", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1943), "Wadi Mujib Canyoning", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1942), 3 },
                    { 10, "relaxation", 30, 20m, 0, "Relax in the soothing hot springs of Ma'in.", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1946), "Ma'in Hot Springs Visit", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1945), 4 },
                    { 11, "historical tour", 20, 25m, 0, "Explore the historic Kerak Castle in Jordan.", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1948), "Kerak Castle Tour", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1947), 4 },
                    { 12, "nature walk", 15, 30m, 0, "Take a nature walk in the Ajloun Forest Reserve.", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1951), "Ajloun Forest Reserve Trek", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1950), 4 },
                    { 13, "food tasting", 12, 40m, 0, "Indulge in a culinary journey through Amman's cuisine.", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1953), "Amman Culinary Tour", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1953), 4 },
                    { 14, "mosaic art", 25, 20m, 0, "Discover the mosaic art of Madaba.", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1961), "Mosaic City Madaba", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1960), 4 },
                    { 15, "historical tour", 18, 30m, 0, "Explore the historic Ajloun Castle.", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1964), "Ajloun Castle Exploration", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1963), 4 },
                    { 16, "beach relaxation", 20, 55m, 0, "Relax on the beautiful beaches of Aqaba.", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1966), "Aqaba Beach Getaway", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1965), 5 },
                    { 17, "snorkeling", 15, 40m, 0, "Explore the underwater world of the Red Sea through snorkeling in Aqaba.", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1969), "Aqaba Snorkeling Adventure", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1968), 5 },
                    { 18, "boat tour", 25, 30m, 0, "View marine life through a glass-bottom boat tour in Aqaba.", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1972), "Aqaba Glass-Bottom Boat Tour", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1971), 5 },
                    { 19, "desert adventure", 12, 45m, 0, "Embark on an exciting jeep safari in the Aqaba desert.", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1977), "Aqaba Desert Jeep Safari", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1976), 6 },
                    { 20, "nightclub hopping", 20, 25m, 0, "Experience the vibrant nightlife of Aqaba.", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1980), "Aqaba Nightlife Tour", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1979), 6 },
                    { 21, "historical tour", 15, 60m, 0, "Explore the iconic Pyramids of Giza in Egypt.", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1983), "Pyramids of Giza Tour", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1982), 6 },
                    { 22, "theater", 18, 60m, 0, "Attend a Broadway show in the heart of New York City.", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1985), "Broadway Show Experience", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1984), 7 },
                    { 23, "museum visit", 20, 30m, 0, "Explore the museums along Museum Mile.", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1988), "Museum Mile Tour", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1987), 7 },
                    { 24, "walking tour", 35, 20m, 0, "Take a scenic walk across the historic Brooklyn Bridge.", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1991), "Brooklyn Bridge Walk", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1990), 7 },
                    { 25, "sightseeing", 30, 35m, 0, "Enjoy panoramic views from the Empire State Building.", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1993), "Empire State Building Observation Deck", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1992), 8 },
                    { 26, "boat tour", 25, 45m, 0, "Cruise along the Hudson River and see Manhattan's skyline.", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1996), "Hudson River Boat Tour", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1995), 8 },
                    { 27, "cultural tour", 20, 45m, 0, "Immerse in the rich culture of Ubud, Bali.", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(1999), "Ubud Cultural Experience", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(1999), 8 },
                    { 28, "snorkeling", 30, 60m, 0, "Explore the vibrant marine life of the Red Sea in Aqaba", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(2002), "Red Sea Adventure", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(2001), 9 },
                    { 29, "off-roading", 20, 50m, 0, "Experience the thrill of a desert adventure in Aqaba", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(2004), "Desert Safari", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(2004), 9 },
                    { 30, "scuba diving", 15, 70m, 0, "Discover submerged historical sites in the Red Sea", new DateTime(2023, 10, 24, 12, 8, 39, 558, DateTimeKind.Utc).AddTicks(2022), "Historical Dive", new DateTime(2023, 10, 24, 15, 8, 39, 558, DateTimeKind.Local).AddTicks(2015), 9 }
                });
